...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Data Jadwal Interview</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item active">Data Jadwal Interview</li>
        </ol>
      </div>
    </div>
  </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    {{-- <td>
                      ...
                      {{ $schedule->vacancy->jobApplications->where('status', 'kualifikasi interview')->count() }} 
                      pelamar</td> --}}
                    <td>
                      ...
                      @include('backoffice.interview.modal.edit-schedule')
                      <a href="/backoffice/interview/{{ $schedule->id }}/detail" class="btn btn-primary btn-sm">
